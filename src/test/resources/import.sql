...
insert into WEB_USER(name,password,email,verifiedEmail,status,createdDate,createdBy) values('guest','084e0343a0486ff05530df6c705c8bb4','carloantonioj@gmail.com',true,'ENABLED',CURDATE(), 'system');
insert into WEB_USER(name,password,email,verifiedEmail,status,createdDate,createdBy) values('admin','21232f297a57a5a743894a0e4a801fc3','carloantonioj@gmail.com',true,'ENABLED',CURDATE(), 'system');
