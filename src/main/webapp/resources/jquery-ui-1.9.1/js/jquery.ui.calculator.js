(function($) {
    $.widget("ui.calculator", {
        ...
        _create: function() {
            ...
            container = div.clone()
            .addClass("ui-calculator-container ui-corner-all ui-widgetcontent ui-helper-clearfix"),
            display = div.clone()
            .addClass("ui-corner-all ui-widget-content ui-calculatordisplay").
            text("0").appendTo(container),
            numberpad = div.clone()
            .addClass("ui-calculator-numberpad").appendTo(container),
            functionpad = div.clone()
            .addClass("ui-calculator-functionpad").appendTo(container),
            ...
            for (var y = 0; y < functions.length; y++) {
                var listitem2 = li.clone().addClass("ui-state-default")
                .appendTo(functionlist),
                linky2 = a.clone().text(functions[y]).appendTo(listitem2);
            }
            this.element
            .addClass("ui-calculator ui-widget ui-helper-reset");
        ...
        destroy: function() {
            ...
            this.element
            .removeClass("ui-calculator ui-widget ui-helper-reset");
        ...
        _buttonClick: function() {
            ...
            if (buttonText == "Backspace") {
                ...
                result = eval
                ($.ui.calculator.prototype.options.currentSum.join(""));
                display.text(result);
